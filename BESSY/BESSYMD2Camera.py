...
class BESSYMD2Camera(Device):      
    ...
    def init(self): 
        logging.getLogger("HWR").info("BESSYMD2Camera: initializing camera hardware object.")
    ...
    def do_image_polling(self, sleep_time):
        while (True):
            try:
                ...
                logging.getLogger("HWR").exception("BESSYMD2Camera: Could not read image")
            else:
                pass
            finally:
