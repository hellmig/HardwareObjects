...
class MicrodiffAperture(MD2Motor):
    ...
    def init(self):
        ...
        self.get_aperture_list = self.getPredefinedPositionsList
    ...
    def connectNotify(self, signal):
        if signal == 'predefinedPositionChanged':
            ...
            try:
                ...
                self.emit('apertureChanged', (int(self.position_attr.getValue()), self.getApertureSize(), ))
        else:
    ...
    def motorPositionChanged(self, absolutePosition, private={}):
        ...
        self.emit('apertureChanged', (int(absolutePosition), self.getApertureSize(), ))
    ...
    def set_active_position(self, new_position):
        ...
        Return      : -
        """
        self.position_attr.setValue(int(new_position))
