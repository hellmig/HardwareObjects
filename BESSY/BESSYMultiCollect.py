...
class TunableEnergy:
    # self.bl_control is passed by BESSYMultiCollect
    @task
    def set_wavelength(self, wavelength):
...
class BESSYMultiCollect(AbstractMultiCollect, HardwareObject):
    ...
    def init(self):
        ...
        # initializes the local detector object with the data specified in the beamline configuration
