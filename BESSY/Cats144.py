...
class Cats144(SampleChanger):
    """
    Actual implementation of the CATS Sample Changer,
    BESSY BL14.1 installation with 3 lids and 144 samples (Unipuck)
    """    
    __TYPE__ = "CATS"    
    NO_OF_LIDS = 3
    NO_OF_BASKETS = 9
    ...
    def __init__(self, *args, **kwargs):
        super(Cats144, self).__init__(self.__TYPE__,False, *args, **kwargs)
    ...
    def init(self):      
        ...
        if self._propNoOfLids is not None:
            try:
                Cats144.NO_OF_LIDS = int(self._propNoOfLids)
            except ValueError:
                pass
            else:
                Cats144.NO_OF_BASKETS = 3 * Cats144.NO_OF_LIDS
        
        # initialize the sample changer components, moved here from __init__ after allowing
        # variable number of lids
        for i in range(Cats144.NO_OF_BASKETS):
        ...
        for basket_index in range(Cats144.NO_OF_BASKETS):            
    ...
    def _directlyUpdateSelectedComponent(self, basket_no, sample_no):    
        ...
        sample = None
        try:
          if basket_no is not None and basket_no>0 and basket_no <=Cats144.NO_OF_BASKETS:
    ...
    def _executeServerTask(self, method, *args):
        ...
        task_id = method(*args)
        print "Cats144._executeServerTask", task_id
        ret=None
    ...
    def _initSCContents(self):
        ...
        basket_list= [('', 4)] * Cats144.NO_OF_BASKETS
