...
class BESSY141BzoomCamera(Device):      
    ...
    def init(self): 
        logging.getLogger("HWR").info("BESSY141BzoomCamera: initializing camera hardware object.")
        ...
        self.video_last_image = self.getChannelObject("video_last_image")
    ...
    def do_image_polling(self, sleep_time):
        while (True):
            try:
                ...
                logging.getLogger("HWR").exception("BESSY141BzoomCamera: Could not read image")
            else:
                pass
            finally:
    ...
    def getImage(self):
          return self.video_last_image.getValue()
    ...
    def takeSnapshot(self,snapshot_filename, bw=True):
        img = self.video_last_image.getValue()
    ...
    def get_new_image(self):
        ...
        Descript. :
        """
        image = self.video_last_image.getValue()
