...
class MicrodiffZoom(MD2Motor):
    ...
    def init(self):
        ...
        if self.predefined_position_attr:
            self.predefined_position_attr.connectSignal("update", self.motorPositionChanged)

        self.predefinedPositions = { "Zoom 1": 1, "Zoom 2": 2, "Zoom 3": 3, "Zoom 4": 4, "Zoom 5": 5, "Zoom 6": 6, "Zoom 7": 7 }
