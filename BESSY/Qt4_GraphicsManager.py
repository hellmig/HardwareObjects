...
class Qt4_GraphicsManager(HardwareObject):
    ...
    def beam_position_changed(self, position):
        ...
        if position:
            ...
            # 2016-05-31-bessy-mh: 
            # call state_changed method to properly update centring positions with 
            # MD2 .Net software because the beam position and scaling factor are updated
    ...
    def diffractometer_state_changed(self, *args):
        ...
        """
        # print "diffractometer_state_changed", self.diffractometer_hwobj.is_ready()
    ...
    def create_centring_point(self, centring_state, centring_status):
        ...
        """
        # print "create_centring_point", centring_state, centring_status
    ...
    def diffractometer_pixels_per_mm_changed(self, pixels_per_mm):
        ...
        """
        # print "diffractometer_pixels_per_mm_changed"
    ...
    def start_centring(self, tree_click=None):
        ...
        :emits: - centringInProgress
                - infoMsg
        """ 
        # print "start_centring", tree_click
